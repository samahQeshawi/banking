            ...
            <div class="modal-body">
                ...
                <div class="card-body d-flex justify-content-center align-items-center">
                    <div class="d-flex align-items-start align-items-sm-center gap-6 position-relative">
                        ...
                        <div class="position-relative">
                            ...
                            <!-- Reset Icon -->
                            <button type="button" class="btn btn-sm btn-danger position-absolute top-0
                            start-100 translate-middle p-1 rounded-circle d-flex align-items-center
                            justify-content-center reset-image" style="width: 24px; height: 24px;">
                                      <i class="ti ti-x"></i>
                            </button>
                        </div>
                ...
                <div class="row">
                    <div class="col mb-4">
                        ...
                        <input type="text" id="updateTitle" name="title" class="form-control" value="{{ old('title') }}" required/>
                            @error('title')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    </div> 
