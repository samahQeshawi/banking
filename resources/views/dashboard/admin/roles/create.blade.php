...
@section('content')
    <form action="{{ route('admin.roles.store') }}" method="POST" id="editForm">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                                                ...
                                                <div class="d-flex">
                                                    @foreach($perms as $pp => $id)
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <input type="checkbox" name="permissions[]" value="{{ $id }}" class="form-check-input permission-checkbox" @if(in_array($id, old('permissions', []))) checked="checked" @endif />
