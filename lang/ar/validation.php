...
return [
    ...
    */
    ...
    'ends_with' => ' (:values) الـ :attribute يجب ان ينتهي بأحد القيم التالية',
    ...
    */
    ...
    'attributes' => [
        ...
        'national_id_expiry_date' => 'تاريخ انتهاء الرقم القومي',
        'personal_address' => 'العنوان الشخصي',
        'governorate_id' => 'المحافظة',
        'birthdate' => 'تاريخ الميلاد',
        'personal_license_date_of_issue' => 'تاريخ إصدار رخصة القيادة الشخصية',
        'license_expiry_date' => 'تاريخ انتهاء رخصة القيادة',
        'personal_license_type' => 'نوع رخصة القيادة الشخصية',
        'identity_front_side' => 'صورة الهوية (الوجه الأمامي)',
        'identity_back_side' => 'صورة الهوية (الوجه الخلفي)',
        'licence_front_side' => 'صورة رخصة القيادة (الوجه الأمامي)',
        'code' => 'الكود',
        'traffic_unit' => 'المرور',
        'load_weight' => 'الحمولة',
        'type' => 'النوع',
        ...
        'license_expire_date' => 'تاريخ انتهاء الرخصة',
        'cylinder_size' => 'حجم الاسطوانة',
        'brand_id' => 'معرف الماركة',
        'model' => 'الموديل',
        'allowed_weight' => 'الوزن المسموح به',
        'color' => 'اللون',
        'license_date_of_issue' => 'تاريخ إصدار الرخصة',
        'truck_type_id' => 'نوع الشاحنة',
        'front_side' => 'الصورة الامامية',
        'back_side' => 'الصورة الخلفية',
        'image' => 'الصورة',
    ],
];
